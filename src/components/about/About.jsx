    ...
    <section className='component-section d-flex flex-column align-items-center justify-content-center py-5' >
      <div className="w-75 m-auto text-center ">
        ...
        <div className="title text-center pt-3">
          <h2 className='text-uppercase text-white fw-bolder fs-1 mb-3' >about component</h2>
        ...
        <div className="mb-5 d-flex gap-2 text-white">
          <p>
            Freelancer is a free bootstrap theme !created by Ziad.
